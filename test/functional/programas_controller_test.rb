...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { codigo_fuente: @programa.codigo_fuente, compilado: @programa.compilado, nombre: @programa.nombre, tipo: @programa.tipo }
    end
  ...
  test "should update programa" do
    put :update, id: @programa, programa: { codigo_fuente: @programa.codigo_fuente, compilado: @programa.compilado, nombre: @programa.nombre, tipo: @programa.tipo }
    assert_redirected_to programa_path(assigns(:programa))
  end
