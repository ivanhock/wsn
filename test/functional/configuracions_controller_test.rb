...
class ConfiguracionsControllerTest < ActionController::TestCase
  ...
  test "should create configuracion" do
    assert_difference('Configuracion.count') do
      post :create, :configuracion => { :xbee_channel => @configuracion.xbee_channel, :xbee_key => @configuracion.xbee_key, :xbee_pan_id => @configuracion.xbee_pan_id, :xbee_port => @configuracion.xbee_port }
    end
  ...
  test "should update configuracion" do
    put :update, :id => @configuracion, :configuracion => { :xbee_channel => @configuracion.xbee_channel, :xbee_key => @configuracion.xbee_key, :xbee_pan_id => @configuracion.xbee_pan_id, :xbee_port => @configuracion.xbee_port }
    assert_redirected_to configuracion_path(assigns(:configuracion))
  end
